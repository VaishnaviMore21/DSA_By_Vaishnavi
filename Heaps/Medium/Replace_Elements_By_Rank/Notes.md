# Replace_Elements_By_Rank

## Problem statement
Solve Replace_Elements_By_Rank using heap-oriented techniques.
...
Optimal approach may combine heap with hashing/two-pointers/greedy as required.
