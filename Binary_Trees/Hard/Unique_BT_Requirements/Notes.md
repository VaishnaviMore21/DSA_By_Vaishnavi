# Unique_BT_Requirements

## Problem statement
Solve Unique_BT_Requirements for binary trees.
...
Brute, better, and optimal differ by traversal strategy, pruning, or auxiliary data structures.
