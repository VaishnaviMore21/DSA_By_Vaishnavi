# Generate_Binary_Strings_Without_Consecutive_1s

## Problem statement
Implement Generate_Binary_Strings_Without_Consecutive_1s in recursive/backtracking style as per Striver A2Z ordering.
